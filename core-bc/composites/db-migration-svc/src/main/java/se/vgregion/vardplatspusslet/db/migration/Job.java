...
public class Job extends AbstractJob {
    ...
    public static void main(String[] args) {
        ...
        se.vgregion.vardplatspusslet.db.migration.util.Users.main method / functions to backup these items, then remove
        ...
        3, Run se.vgregion.vardplatspusslet.db.migration.ImportHistory.main. That will migrate historik-table to
        archived_data.
